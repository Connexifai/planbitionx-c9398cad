        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="lg:hidden flex flex-col items-center mb-4">
            <img
              src={robotImg}
              alt="Planbition X"
              className="w-32 h-32 object-contain drop-shadow-xl animate-[orbit_6s_ease-in-out_infinite] hover:scale-110 transition-transform duration-500 cursor-pointer mb-4"
            />
