            ...
            <>
              {!chatOpen && (
                <img
                  ...
                  className="fixed bottom-8 right-8 z-50 w-56 h-56 object-contain drop-shadow-2xl animate-[orbit_4s_ease-in-out_infinite] hover:scale-110 transition-transform duration-500 cursor-pointer"
                />
              )}
