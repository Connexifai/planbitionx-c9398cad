                ...
                {jsonLoaded && !chatOpen && (
                  <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2 cursor-pointer" onClick={() => setChatOpen(true)}>
                    ...
                    <img
                      src={robotImg}
                      alt="AI Briefing"
                      className="w-56 h-56 object-contain drop-shadow-2xl animate-[orbitsm_30s_ease-in-out_infinite] hover:scale-110 transition-transform duration-500"
                    />
                  </div>
                )}
              </div>
              ...
              {solved && !chatOpen && (
                <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2 cursor-pointer" onClick={() => setChatOpen(true)}>
                  ...
                  <img
                    src={robotImg}
                    alt="AI Assistent"
                    className="w-56 h-56 object-contain drop-shadow-2xl animate-[orbitsm_6s_ease-in-out_infinite] hover:scale-110 transition-transform duration-500"
                  />
                </div>
              )}
