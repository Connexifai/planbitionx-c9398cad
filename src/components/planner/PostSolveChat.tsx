  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex items-start justify-center pt-8 px-4 shrink-0">
        <img src={robotImg} alt="AI Assistant" className="w-56 h-56 object-contain drop-shadow-2xl animate-[orbit_6s_ease-in-out_infinite] hover:scale-110 transition-transform duration-500 cursor-pointer" />
      </div>
