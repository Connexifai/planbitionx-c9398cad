...
export function RosterGrid() {
  ...
  return (
    <div className="roster-scroll w-full rounded-xl border border-border/50 bg-card shadow-sm overflow-x-auto overflow-y-auto max-h-[calc(100vh-280px)]">
      <div className="min-w-[1400px]">
        ...
        {employees.map((emp, rowIdx) => {
          ...
          return (
            <div
              key={emp.id}
              className={`grid grid-cols-[220px_repeat(14,minmax(80px,1fr))] border-b last:border-b-0 transition-colors hover:bg-accent/30 ${rowIdx % 2 === 0 ? "" : "bg-accent/10"}`}
            >
              {/* Employee info */}
